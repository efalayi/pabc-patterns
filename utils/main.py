...
def transform_dataset(dataset):
    ...
    # 'No': left, 'Yes': right
    transformed_dataset['Lesions'] = transformed_dataset['Lesions'].replace([1, 2], ['No', 'Yes'])

    # 'No': no family history, 'Yes': there is family history
    transformed_dataset['Family history'] = transformed_dataset['Family history'].replace([0, 1], ['No', 'Yes'])

    # 'No': negative, 'Yes': positive
    transformed_dataset['HR'] = transformed_dataset['HR'].replace([0, 1], ['No', 'Yes'])

    # 'No': negative, 'Yes': positive
    transformed_dataset['HER-2'] = transformed_dataset['HER-2'].replace([0, 1], ['No', 'Yes'])

    # 'No': normal, 'Yes': recur
    transformed_dataset['DFS'] = transformed_dataset['DFS'].replace([0, 1], ['No', 'Yes'])

    # 'No': survival, 'Yes': death
    transformed_dataset['OS status'] = transformed_dataset['OS status'].replace([0, 1], ['No', 'Yes'])
